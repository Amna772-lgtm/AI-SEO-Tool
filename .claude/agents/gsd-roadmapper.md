...
Reference full template: `D:/AI SEO Tool/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/AI SEO Tool/.claude/get-shit-done/templates/state.md`.
