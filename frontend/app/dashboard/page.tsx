...
// ── Types ──────────────────────────────────────────────────────────────────────
type MainTab = "dashboard" | "geo" | "insights" | "history" | "schedules" | "competitors" | "settings";
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[var(--background)] text-[var(--foreground)]">
      ...
      <aside className="sidebar-dark flex w-52 shrink-0 flex-col" style={{ background: "linear-gradient(160deg, rgb(15, 32, 39), rgb(30, 58, 58), rgb(15, 32, 39))", borderRight: "1px solid rgba(255, 255, 255, 0.08)" }}>
        ...
        <nav className="flex flex-col gap-0 p-2 pt-3">
          {(
            [
              {
                category: "Audit",
            ...
            ] as { category: string; items: { id: MainTab; label: string; icon: React.ReactNode }[] }[]
          ).map((group) => (
